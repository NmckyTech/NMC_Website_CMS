...
const navMenus = {
    about: [
        ...
        { group: [{ text: "Volunteer Leadership", href: "volunteer-leadership.html" }] },
    ],
    ministries: [
    ...
    giving: [
        { group: [{ text: "Give Online", href: "giving.html #give-online" }] },
        { group: [{ text: "Ways to Give", href: "giving.html #ways-to-give" }] }
    ],
    events: [
